...
describe('Pet Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pet', component: PetComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to petService', () => {
      ...
      expect(service.getPetIdentifier).toHaveBeenCalledWith(entity);
